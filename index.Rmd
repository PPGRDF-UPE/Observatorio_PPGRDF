...
```{r meta-observatorio, eval = !any(has.logo.ppg, has.sucupira.files, has.financiadores, has.producao.ppg, has.producao.sucupira, has.discentes, has.posdocs)}
...
if (length(mundo) > 0) {
  ...
  ggplot2::ggplot() +
    ggplot2::geom_polygon(data = worldmap, aes(
      x = long,
      y = lat,
      group = group,
      fill = Freq
