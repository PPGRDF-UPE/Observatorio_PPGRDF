...
for (periodo in periodos) {
  # read Rmd header
  rmd <- readLines(paste0("autoavaliacao.Rmd"))
  # replace period
  rmd <- gsub("2021;2022;2023;2024", paste0(as.numeric(strsplit(periodo, "-")[[1]][1]):as.numeric(strsplit(periodo, "-")[[1]][2]), collapse = ";"), rmd)
  # write Rmd
  writeLines(rmd, paste0("autoavaliacao ", periodo, ".Rmd"))
}
```
