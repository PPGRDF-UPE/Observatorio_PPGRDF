...
```{r descritivo-omissos, eval = has.sucupira.files, cache = TRUE, cache.path = "cache/missing/"}
# print tables
table.missing.gt <-
  gtsummary::tbl_summary(
    summ.missing.wider,
...
```{r descritivo-duplicados, eval = has.sucupira.files, cache = TRUE, cache.path = "cache/missing/"}
# print tables
table.duplicates.gt <-
  gtsummary::tbl_summary(
...
# Escape ampersand in table data
try(table <- apply(table, 2, function(x) gsub("&", "e", x)), silent = TRUE)
